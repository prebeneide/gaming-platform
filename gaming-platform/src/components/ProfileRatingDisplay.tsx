...
export default function ProfileRatingDisplay({ gameRatings, className = "", isOwnProfile = false }: ProfileRatingDisplayProps) {
    ...
    return (
      <div className={`bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-800 rounded-xl p-6 border border-neutral-700 shadow-xl ${className}`}>
        <div className="text-center text-neutral-400">
          ...
          <div className="text-lg font-semibold mb-2">No Game Ratings Yet</div>
  ...
  const sortedRatings = [...gameRatings].sort((a, b) => b.rating - a.rating);
  ...
  const selectedRating = gameRatings.find(r => r.gameName === selectedGame) || bestRating;
    ...
    <div className={`bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-800 rounded-xl p-6 border border-neutral-700 shadow-xl ${className}`}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-neutral-400 text-sm">Best rating: {bestRating?.gameName}</p>
        </div>
